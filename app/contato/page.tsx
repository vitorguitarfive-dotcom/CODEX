...
export const metadata: Metadata = createPageMetadata(
  'Contato — Denkor',
  'Fale com a Denkor sobre formações ou programas para empresas.',
);
...
export default function ContatoPage() {
  return (
    <main className="min-h-screen bg-background text-foreground">
      ...
      <InnerHero
        eyebrow="Contato"
        title="Escolha o contexto e a conversa já começa no assunto certo."
        text="Sem formulário e sem espera: a mensagem já vai preenchida e alguém da Denkor responde."
        index="04"
      />
        ...
        <div className="mx-auto max-w-[1440px] px-5 py-16 sm:px-8 lg:px-12 lg:py-24">
          ...
          <div className="mt-10 grid gap-px bg-[#101412]/15 lg:grid-cols-2">
            <article className="bg-white p-7 sm:p-10 lg:p-12">
              <BriefcaseBusiness
                className="size-8 text-[#769149]"
                strokeWidth={1.5}
                aria-hidden="true"
              />
              <p className="mt-16 text-xs font-semibold uppercase tracking-[0.2em] text-[#526057]">
                Para profissionais
              </p>
              ...
              <p className="mt-5 max-w-xl leading-7 text-[#526057]">
                Converse sobre as formações e descubra qual caminho combina com
            ...
            <article className="bg-[#101412] p-7 text-white sm:p-10 lg:p-12">
              <Building2
                className="size-8 text-[#dff57a]"
                strokeWidth={1.5}
                aria-hidden="true"
              />
              <p className="mt-16 text-xs font-semibold uppercase tracking-[0.2em] text-white/65">
                Para empresas
              </p>
              ...
              <p className="mt-5 max-w-xl leading-7 text-white/65">
                Conte o desafio da sua operação e entenda qual programa pode
                ajudar sua empresa a começar.
              </p>
              <div className="mt-9">
                <WhatsAppButton
      ...
      <SiteFooter contextKey="contato_geral" ctaId="footer-whatsapp" />
    </main>
  );
}
